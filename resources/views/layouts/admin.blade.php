...
<head>
    ...
    <title>CRUD Laravel 10 | Starter</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('/') }}" class="brand-link">
                <img src="{{ url('dist/img/G-letra.jpg') }}" alt="GUFRA Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">CRUD en Laravel 10</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ url('dist/img/ms-icon-150x150.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            <li class="nav-item" style="background-color:rgb(255, 0, 0)">
                                <a href="{{ route('logout') }}" class="nav-link"
                                    onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();">
                                    <i class="nav-icon fas"><i class="bi-door-closed"></i></i>
                                    <p>
                                        Cerrar Session
        ...
        <div class="content-wrapper">
            <br>
            {{-- Mensaje e Icono de SweetAlert2 --}}
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2014-2024 <a href="https://guframexico.com">GUFRA Mexico</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
    ...
    <script type='text/javascript' src='{{ url('dist/js/adminlte.min.js') }}'></script>
    <!-- BootStrap -->
